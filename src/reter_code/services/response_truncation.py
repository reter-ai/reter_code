...
When responses exceed the limit, full results are saved to .reter_code/results/
...
RESULTS_DIR_NAME = ".reter_code/results"
...
def truncate_response(response: Dict[str, Any], query_hint: str = "") -> Dict[str, Any]:
    ...
    .reter_code/results/ and a reference is returned along with a summary.
